/**
 * Created by Ivan Taranin (john) on 12.08.19.
...
ShaderToy.prototype = {
    ...
    _fragmentShader: [
        ...
        'void mainImage( out vec4 fragColor, in vec2 fragCoord ) { fragColor.rgb = vec3( 0.5 + 0.5 * cos( iTime ) ); }',
    ...
    _setU3fv: function (name, v3) {

        this.gl.uniform3fv(this._getUniform(name), v3);
    ...
    render: function () {
        ...
        this._setU1f('iTime', (Date.now() - this.startTime) / 1000);
        this._setU3fv('iMouse', this.mouse);
